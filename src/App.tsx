...
function App() {
  return (
    <main className="bg-[url('./assets/img/bg.jpeg')] bg-no-repeat bg-center bg-cover h-screen w-screen">
      <div className="w-full h-full border border-red-300 grid grid-cols-8 grid-rows-3">
        ...
        <Menu className="h-full w-full bg-yellow-500 col-span-1 row-span-2 " />
        <Activities className="h-full w-full bg-red-200 col-span-4 row-span-1" />
